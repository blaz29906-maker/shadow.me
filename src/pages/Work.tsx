        ...
        <div className="w-full flex flex-col gap-32">
            ...
            <section id="reels" className="w-full overflow-hidden pt-12">
                ...
                <div className="w-full flex overflow-hidden py-8">
                    <DraggableMarquee speed={1.2} direction="left" contentClassName="gap-4 sm:gap-6 pr-4 sm:pr-6">
                        {TRAFFIC_VIDEOS.map((video, idx) => (
                            <div key={`g1-${idx}`} className="w-[280px] sm:w-[320px] lg:w-[380px] shrink-0 aspect-[9/16] relative group rounded-xl overflow-hidden bg-studio-dark border border-white/5 shadow-2xl">
                                ...
                                />
                                {/* Overlay details */}
                                <div className="absolute top-4 left-4 z-20 px-3 py-1 bg-black/60 backdrop-blur-md rounded border border-white/10 text-white/90 text-sm font-heading tracking-widest pointer-events-none">
                                    {video.views} VIEWS
                                </div>
                            </div>
                        ))}
            ...
            <section id="thumbnails">
                ...
                <div className="w-full flex flex-col gap-6 overflow-hidden">
                    ...
                    <DraggableMarquee speed={1} direction="right" contentClassName="gap-4 sm:gap-6 pr-4 sm:pr-6">
            ...
            <section id="commercials">
                ...
                <div className="w-full flex overflow-hidden max-w-[1800px] mx-auto py-8">
                    <DraggableMarquee speed={1.2} direction="left" contentClassName="gap-4 sm:gap-6 pr-4 sm:pr-6">
                        {[
                            ...
                            <div key={`c1-${idx}`} className="w-[400px] sm:w-[500px] lg:w-[600px] shrink-0 aspect-[16/9] bg-studio-dark border border-white/5 rounded-xl overflow-hidden relative group cursor-pointer hover:border-emerald-glow/50 transition-colors duration-500 shadow-xl">
                                <LazyVideo
                                    src={src}
                                    className="opacity-80 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
                                />
                                {/* Progress Bar Container */}
                                <div className="absolute bottom-0 left-0 w-full h-12 bg-gradient-to-t from-black/80 to-transparent flex items-end px-6 pb-4 pointer-events-none">
